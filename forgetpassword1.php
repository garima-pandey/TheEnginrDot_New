...
$mail->setFrom('theenginrdot@gmail.com', 'The Enginr Dot');
...
$bodyContent .= '<a href="http://0b0c99ec.ngrok.io/myshop/newpassword?id='.$token.'&cid='.base64_encode($email).'">Click here</a>';
...
if($query002 && $mail->send())
    echo "<script>alert('Check your mail!');window.location='index'</script>";
}
else{
